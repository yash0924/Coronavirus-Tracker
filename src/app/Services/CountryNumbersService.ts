...
export class CountryNumbersService {
   ...
   GetCurrentLocationInfo()
   {
    ...
    getLatestNews(){
       return this.http.get("http://newsapi.org/v2/top-headlines?q=coronavirus&country=us&country=uk&country=ch&country=in&sortBy=publishedAt&language=en&apiKey=0e283689abe54696987ae8a1f6537804");
    }
